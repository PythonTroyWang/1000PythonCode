...
def yl_video(video_path, wx_text):
    ...
    with VideoFileClip(video_path) as video_clip:
        # 裁剪前5秒并调整大小
        cropped_clip = video_clip.subclip(0, 5).resize((400, 255))
        ...
        # 设置 GIF 图像的位置
        looped_arrow_clip = looped_arrow_clip.set_position((center_x, 50)).set_duration(5)
        ...
        # 将组合后的视频剪辑写入文件
        output_path = os.path.join(output_directory, f"{wx_text}.mp4")
